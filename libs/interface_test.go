...
//	res,_ := EncryptLoginPktSM2(param.Username, []byte(param.Privkdata), []byte(param.Pubkdata), data)
//	fmt.Println("res:", res)
//}
//
...
//	res,_ := DecryptLoginPktSM2([]byte(param.Privkdata), []byte(param.Pubkdata), common.FromHex(data))
//	fmt.Println("res:", res)
//}
